...
var unicode = '' + Date.now();
var md5 = crypto.createHash('md5');
var unicodeMd5 = md5.update(unicode)
    .digest('hex')
    .substring(0, 6);

var defineMd5 = 'define' + unicodeMd5;
...
var initCommonJSModuleCore = function () {
    var moduleImp = fs.readFileSync(baseModuleFile + '.js', 'utf-8').toString().replace(/window\.define/g, 'window.define' + unicodeMd5);
